...
- Steps 20-48 Initializing Proxmox for Virtualization
...
-- Disks Tab: Disk Size: 32 GB is plenty for Ubuntu Server and a Flask app. Leave everything else default. Click Next.
-- CPU Tab: Cores: If the laptop is a low-end dual-core, assign 1-2 cores. If it is a high-end i7/Ryzen, assign 4 cores. Click Next.
...
-- Confirm: Click Finish. You will see the new VM appear in the left sidebar.
...
Steps 1-8 Initializing the Web App VM
...
Steps 9-X Enabling & Initializing Cloudflare Zero Trust Tunneling for External Access
